...
`
const borderT = 'border-t border-solid border-border border-b-0 border-x-0'
    ...
    <Html lang='en'>
      ...
      <Tailwind config={twconfig}>
        <Body
          ...
          style={{}}
        >
          <div className='border border-solid border-border rounded max-w-[465px]'>
            <Header />
            <div className={`p-2 ${borderT}`}>{children}</div>
            <Footer className={`${borderT}`} />
          </div>
        </Body>
      </Tailwind>
    </Html>
